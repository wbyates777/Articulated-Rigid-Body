...
public:
    ...
    operator*( const BMatrix63 &m ) const  
    {
        ...
        retVal[0][0] = (m_I[0][0] * m[0][0]) + (m_I[1][0] * m[1][0]) + (m_I[2][0] * m[2][0])  +  (m_H[0][0] * m[3][0]) + (m_H[0][1] * m[4][0]) + (m_H[0][2] * m[5][0]); 
        retVal[1][0] = (m_I[0][1] * m[0][0]) + (m_I[1][1] * m[1][0]) + (m_I[2][1] * m[2][0])  +  (m_H[1][0] * m[3][0]) + (m_H[1][1] * m[4][0]) + (m_H[1][2] * m[5][0]); 
        retVal[2][0] = (m_I[0][2] * m[0][0]) + (m_I[1][2] * m[1][0]) + (m_I[2][2] * m[2][0])  +  (m_H[2][0] * m[3][0]) + (m_H[2][1] * m[4][0]) + (m_H[2][2] * m[5][0]); 
        
        retVal[3][0] = (m_H[0][0] * m[0][0]) + (m_H[1][0] * m[1][0]) + (m_H[2][0] * m[2][0])  +  (m_M[0][0] * m[3][0]) + (m_M[1][0] * m[4][0]) + (m_M[2][0] * m[5][0]);
        retVal[4][0] = (m_H[0][1] * m[0][0]) + (m_H[1][1] * m[1][0]) + (m_H[2][1] * m[2][0])  +  (m_M[0][1] * m[3][0]) + (m_M[1][1] * m[4][0]) + (m_M[2][1] * m[5][0]);
        retVal[5][0] = (m_H[0][2] * m[0][0]) + (m_H[1][2] * m[1][0]) + (m_H[2][2] * m[2][0])  +  (m_M[0][2] * m[3][0]) + (m_M[1][2] * m[4][0]) + (m_M[2][2] * m[5][0]);
        
        
        retVal[0][1] = (m_I[0][0] * m[0][1]) + (m_I[1][0] * m[1][1]) + (m_I[2][0] * m[2][1])  +  (m_H[0][0] * m[3][1]) + (m_H[0][1] * m[4][1]) + (m_H[0][2] * m[5][1]); 
        retVal[1][1] = (m_I[0][1] * m[0][1]) + (m_I[1][1] * m[1][1]) + (m_I[2][1] * m[2][1])  +  (m_H[1][0] * m[3][1]) + (m_H[1][1] * m[4][1]) + (m_H[1][2] * m[5][1]); 
        retVal[2][1] = (m_I[0][2] * m[0][1]) + (m_I[1][2] * m[1][1]) + (m_I[2][2] * m[2][1])  +  (m_H[2][0] * m[3][1]) + (m_H[2][1] * m[4][1]) + (m_H[2][2] * m[5][1]); 
        
        retVal[3][1] = (m_H[0][0] * m[0][1]) + (m_H[1][0] * m[1][1]) + (m_H[2][0] * m[2][1])  +  (m_M[0][0] * m[3][1]) + (m_M[1][0] * m[4][1]) + (m_M[2][0] * m[5][1]);
        retVal[4][1] = (m_H[0][1] * m[0][1]) + (m_H[1][1] * m[1][1]) + (m_H[2][1] * m[2][1])  +  (m_M[0][1] * m[3][1]) + (m_M[1][1] * m[4][1]) + (m_M[2][1] * m[5][1]);
        retVal[5][1] = (m_H[0][2] * m[0][1]) + (m_H[1][2] * m[1][1]) + (m_H[2][2] * m[2][1])  +  (m_M[0][2] * m[3][1]) + (m_M[1][2] * m[4][1]) + (m_M[2][2] * m[5][1]);
       
        
        retVal[0][2] = (m_I[0][0] * m[0][2]) + (m_I[1][0] * m[1][2]) + (m_I[2][0] * m[2][2])  +  (m_H[0][0] * m[3][2]) + (m_H[0][1] * m[4][2]) + (m_H[0][2] * m[5][2]); 
        retVal[1][2] = (m_I[0][1] * m[0][2]) + (m_I[1][1] * m[1][2]) + (m_I[2][1] * m[2][2])  +  (m_H[1][0] * m[3][2]) + (m_H[1][1] * m[4][2]) + (m_H[1][2] * m[5][2]); 
        retVal[2][2] = (m_I[0][2] * m[0][2]) + (m_I[1][2] * m[1][2]) + (m_I[2][2] * m[2][2])  +  (m_H[2][0] * m[3][2]) + (m_H[2][1] * m[4][2]) + (m_H[2][2] * m[5][2]); 
        
        retVal[3][2] = (m_H[0][0] * m[0][2]) + (m_H[1][0] * m[1][2]) + (m_H[2][0] * m[2][2])  +  (m_M[0][0] * m[3][2]) + (m_M[1][0] * m[4][2]) + (m_M[2][0] * m[5][2]);
        retVal[4][2] = (m_H[0][1] * m[0][2]) + (m_H[1][1] * m[1][2]) + (m_H[2][1] * m[2][2])  +  (m_M[0][1] * m[3][2]) + (m_M[1][1] * m[4][2]) + (m_M[2][1] * m[5][2]);
        retVal[5][2] = (m_H[0][2] * m[0][2]) + (m_H[1][2] * m[1][2]) + (m_H[2][2] * m[2][2])  +  (m_M[0][2] * m[3][2]) + (m_M[1][2] * m[4][2]) + (m_M[2][2] * m[5][2]);
